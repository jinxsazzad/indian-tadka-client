  ...
  return (
    <div className="navbar bg-slate-300">
      <div className="navbar-start">
        ...
        <Link to={"/"} className="">
        <h1 id="chefs" className="text-3xl font-bold text-gray-800 text-center">Indian Tadka</h1>
      ...
      <div className="navbar-center hidden lg:flex">
        <ul className="menu menu-horizontal px-1">
          ...
          <li tabIndex={0}>
            <a href="#chefs" className="text-base font-bold">Chefs</a>
          </li>
          <li>
            <NavLink className="text-base font-bold" to={"/blog"}>Blog</NavLink>
          </li>
        ...
        <div className="dropdown dropdown-end flex justify-center items-center">
          {user ? (
            <>
              ...
              <button onClick={handleLogout} className=" text-base font-bold btn btn-outline ms-2">
                Log Out
              </button>
            </>
          ) : (
